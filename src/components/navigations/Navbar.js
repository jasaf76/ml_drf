              ...
              <NavLink
                ...
                <div className="flex h-8 w-8 shrink-0 items-center justify-center text-white dark:text-dark-txt sm:h-12 sm:w-12">
                  <img
                    ...
                    src={`${process.env.REACT_APP_API_URL}${my_user && my_user.picture}`}
                  />
                </div>
                <div className="ml-4">
            ...
            <div className="bg-gray-50 dark:bg-dark-second p-4">
              <div
                ...
                <span className="flex items-center">
                  <button className="text-sm font-gilroy-medium dark:text-dark-txt text-white bg-red-500 rounded-md  dark:bg-dark-second px-3">
                    Auslogen
                  </button>
                </span>
    ...
    <Fragment>
      ...
      <div className="hidden lg:flex lg:items-center lg:justify-end xl:col-span-4">
        <Popover
          ...
          {ethereum_balance && (
            <p className="inline-flex mt-1.5 mr-2 text-md font-gilroy-semibold text-gray-700  dark:bg-white">
